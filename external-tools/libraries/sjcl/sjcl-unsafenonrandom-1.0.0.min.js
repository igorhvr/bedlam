"use strict";function p(a){throw a;}var r=void 0,x=!0,C=!1;var sjcl={cipher:{},hash:{},keyexchange:{},mode:{},misc:{},codec:{},exception:{corrupt:function(a){this.toString=function(){return"CORRUPT: "+this.message};this.message=a},invalid:function(a){this.toString=function(){return"INVALID: "+this.message};this.message=a},bug:function(a){this.toString=function(){return"BUG: "+this.message};this.message=a},notReady:function(a){this.toString=function(){return"NOT READY: "+this.message};this.message=a}}};
...
sjcl.codec.bytes={fromBits:function(a){var b=[],c=sjcl.bitArray.bitLength(a),d,e;for(d=0;d<c/8;d++)0===(d&3)&&(e=a[d/4]),b.push(e>>>24),e<<=8;return b},toBits:function(a){var b=[],c,d=0;for(c=0;c<a.length;c++)d=d<<8|a[c],3===(c&3)&&(b.push(d),d=0);c&3&&b.push(sjcl.bitArray.partial(8*(c&3),d));return b}};sjcl.hash.sha256=function(a){this.d[0]||this.F();a?(this.f=a.f.slice(0),this.e=a.e.slice(0),this.c=a.c):this.reset()};sjcl.hash.sha256.hash=function(a){return(new sjcl.hash.sha256).update(a).finalize()};
sjcl.hash.sha256.prototype={blockSize:512,reset:function(){this.f=this.l.slice(0);this.e=[];this.c=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.e=sjcl.bitArray.concat(this.e,a);b=this.c;a=this.c=b+sjcl.bitArray.bitLength(a);for(b=512+b&-512;b<=a;b+=512)this.j(c.splice(0,16));return this},finalize:function(){var a,b=this.e,c=this.f,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+2;a&15;a++)b.push(0);b.push(Math.floor(this.c/
4294967296));for(b.push(this.c|0);b.length;)this.j(b.splice(0,16));this.reset();return c},l:[],d:[],F:function(){function a(a){return 0x100000000*(a-Math.floor(a))|0}var b=0,c=2,d;a:for(;64>b;c++){for(d=2;d*d<=c;d++)if(0===c%d)continue a;8>b&&(this.l[b]=a(Math.pow(c,0.5)));this.d[b]=a(Math.pow(c,1/3));b++}},j:function(a){var b,c,d=a.slice(0),e=this.f,f=this.d,g=e[0],h=e[1],k=e[2],l=e[3],n=e[4],m=e[5],q=e[6],t=e[7];for(a=0;64>a;a++)16>a?b=d[a]:(b=d[a+1&15],c=d[a+14&15],b=d[a&15]=(b>>>7^b>>>18^b>>>3^
b<<25^b<<14)+(c>>>17^c>>>19^c>>>10^c<<15^c<<13)+d[a&15]+d[a+9&15]|0),b=b+t+(n>>>6^n>>>11^n>>>25^n<<26^n<<21^n<<7)+(q^n&(m^q))+f[a],t=q,q=m,m=n,n=l+b|0,l=k,k=h,h=g,g=b+(h&k^l&(h^k))+(h>>>2^h>>>13^h>>>22^h<<30^h<<19^h<<10)|0;e[0]=e[0]+g|0;e[1]=e[1]+h|0;e[2]=e[2]+k|0;e[3]=e[3]+l|0;e[4]=e[4]+n|0;e[5]=e[5]+m|0;e[6]=e[6]+q|0;e[7]=e[7]+t|0}};sjcl.hash.sha512=function(a){this.d[0]||this.F();a?(this.f=a.f.slice(0),this.e=a.e.slice(0),this.c=a.c):this.reset()};sjcl.hash.sha512.hash=function(a){return(new sjcl.hash.sha512).update(a).finalize()};
sjcl.hash.sha512.prototype={blockSize:1024,reset:function(){this.f=this.l.slice(0);this.e=[];this.c=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.e=sjcl.bitArray.concat(this.e,a);b=this.c;a=this.c=b+sjcl.bitArray.bitLength(a);for(b=1024+b&-1024;b<=a;b+=1024)this.j(c.splice(0,32));return this},finalize:function(){var a,b=this.e,c=this.f,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+4;a&31;a++)b.push(0);b.push(0);b.push(0);
b.push(Math.floor(this.c/0x100000000));for(b.push(this.c|0);b.length;)this.j(b.splice(0,32));this.reset();return c},l:[],qa:[12372232,13281083,9762859,1914609,15106769,4090911,4308331,8266105],d:[],ra:[2666018,15689165,5061423,9034684,4764984,380953,1658779,7176472,197186,7368638,14987916,16757986,8096111,1480369,13046325,6891156,15813330,5187043,9229749,11312229,2818677,10937475,4324308,1135541,6741931,11809296,16458047,15666916,11046850,698149,229999,945776,13774844,2541862,12856045,9810911,11494366,
...
c;d++){for(e=2;e*e<=d;e++)if(0===d%e)continue a;8>c&&(this.l[2*c]=a(Math.pow(d,0.5)),this.l[2*c+1]=b(Math.pow(d,0.5))<<24|this.qa[c]);this.d[2*c]=a(Math.pow(d,1/3));this.d[2*c+1]=b(Math.pow(d,1/3))<<24|this.ra[c];c++}},j:function(a){var b,c,d=a.slice(0),e=this.f,f=this.d,g=e[0],h=e[1],k=e[2],l=e[3],n=e[4],m=e[5],q=e[6],t=e[7],s=e[8],E=e[9],G=e[10],F=e[11],aa=e[12],Q=e[13],ba=e[14],R=e[15],y=g,v=h,J=k,H=l,K=n,I=m,V=q,L=t,z=s,w=E,S=G,M=F,T=aa,N=Q,W=ba,O=R;for(a=0;80>a;a++){if(16>a)b=d[2*a],c=d[2*a+
1];else{c=d[2*(a-15)];var u=d[2*(a-15)+1];b=(u<<31|c>>>1)^(u<<24|c>>>8)^c>>>7;var A=(c<<31|u>>>1)^(c<<24|u>>>8)^(c<<25|u>>>7);c=d[2*(a-2)];var B=d[2*(a-2)+1],u=(B<<13|c>>>19)^(c<<3|B>>>29)^c>>>6,B=(c<<13|B>>>19)^(B<<3|c>>>29)^(c<<26|B>>>6),X=d[2*(a-7)],Y=d[2*(a-16)],P=d[2*(a-16)+1];c=A+d[2*(a-7)+1];b=b+X+(c>>>0<A>>>0?1:0);c+=B;b+=u+(c>>>0<B>>>0?1:0);c+=P;b+=Y+(c>>>0<P>>>0?1:0)}d[2*a]=b|=0;d[2*a+1]=c|=0;var X=z&S^~z&T,ca=w&M^~w&N,B=y&J^y&K^J&K,ga=v&H^v&I^H&I,Y=(v<<4|y>>>28)^(y<<30|v>>>2)^(y<<25|v>>>
7),P=(y<<4|v>>>28)^(v<<30|y>>>2)^(v<<25|y>>>7),ha=f[2*a],da=f[2*a+1],u=O+((z<<18|w>>>14)^(z<<14|w>>>18)^(w<<23|z>>>9)),A=W+((w<<18|z>>>14)^(w<<14|z>>>18)^(z<<23|w>>>9))+(u>>>0<O>>>0?1:0),u=u+ca,A=A+(X+(u>>>0<ca>>>0?1:0)),u=u+da,A=A+(ha+(u>>>0<da>>>0?1:0)),u=u+c,A=A+(b+(u>>>0<c>>>0?1:0));c=P+ga;b=Y+B+(c>>>0<P>>>0?1:0);W=T;O=N;T=S;N=M;S=z;M=w;w=L+u|0;z=V+A+(w>>>0<L>>>0?1:0)|0;V=K;L=I;K=J;I=H;J=y;H=v;v=u+c|0;y=A+b+(v>>>0<u>>>0?1:0)|0}h=e[1]=h+v|0;e[0]=g+y+(h>>>0<v>>>0?1:0)|0;l=e[3]=l+H|0;e[2]=k+J+(l>>>
0<H>>>0?1:0)|0;m=e[5]=m+I|0;e[4]=n+K+(m>>>0<I>>>0?1:0)|0;t=e[7]=t+L|0;e[6]=q+V+(t>>>0<L>>>0?1:0)|0;E=e[9]=E+w|0;e[8]=s+z+(E>>>0<w>>>0?1:0)|0;F=e[11]=F+M|0;e[10]=G+S+(F>>>0<M>>>0?1:0)|0;Q=e[13]=Q+N|0;e[12]=aa+T+(Q>>>0<N>>>0?1:0)|0;R=e[15]=R+O|0;e[14]=ba+W+(R>>>0<O>>>0?1:0)|0}};sjcl.hash.sha1=function(a){a?(this.f=a.f.slice(0),this.e=a.e.slice(0),this.c=a.c):this.reset()};sjcl.hash.sha1.hash=function(a){return(new sjcl.hash.sha1).update(a).finalize()};
sjcl.hash.sha1.prototype={blockSize:512,reset:function(){this.f=this.l.slice(0);this.e=[];this.c=0;return this},update:function(a){"string"===typeof a&&(a=sjcl.codec.utf8String.toBits(a));var b,c=this.e=sjcl.bitArray.concat(this.e,a);b=this.c;a=this.c=b+sjcl.bitArray.bitLength(a);for(b=this.blockSize+b&-this.blockSize;b<=a;b+=this.blockSize)this.j(c.splice(0,16));return this},finalize:function(){var a,b=this.e,c=this.f,b=sjcl.bitArray.concat(b,[sjcl.bitArray.partial(1,1)]);for(a=b.length+2;a&15;a++)b.push(0);
b.push(Math.floor(this.c/0x100000000));for(b.push(this.c|0);b.length;)this.j(b.splice(0,16));this.reset();return c},l:[1732584193,4023233417,2562383102,271733878,3285377520],d:[1518500249,1859775393,2400959708,3395469782],j:function(a){var b,c,d,e,f,g,h=a.slice(0),k=this.f;c=k[0];d=k[1];e=k[2];f=k[3];g=k[4];for(a=0;79>=a;a++)16<=a&&(h[a]=(h[a-3]^h[a-8]^h[a-14]^h[a-16])<<1|(h[a-3]^h[a-8]^h[a-14]^h[a-16])>>>31),b=19>=a?d&e|~d&f:39>=a?d^e^f:59>=a?d&e|d&f|e&f:79>=a?d^e^f:r,b=(c<<5|c>>>27)+b+g+h[a]+this.d[Math.floor(a/
...
sjcl.misc.hmac.prototype.encrypt=sjcl.misc.hmac.prototype.mac=function(a){this.ga&&p(new sjcl.exception.invalid("encrypt on already updated hmac called!"));this.update(a);return this.digest(a)};sjcl.misc.hmac.prototype.reset=function(){this.T=new this.$(this.C[0]);this.ga=C};sjcl.misc.hmac.prototype.update=function(a){this.ga=x;this.T.update(a)};sjcl.misc.hmac.prototype.digest=function(){var a=this.T.finalize(),a=(new this.$(this.C[1])).update(a).finalize();this.reset();return a};
...
sjcl.prng=function(a){this.i=[new sjcl.hash.sha256];this.u=[0];this.S=0;this.K={};this.R=0;this.X={};this.da=this.m=this.w=this.la=0;this.d=[0,0,0,0,0,0,0,0];this.p=[0,0,0,0];this.P=r;this.Q=a;this.H=C;this.O={progress:{},seeded:{}};this.B=this.ka=0;this.L=1;this.M=2;this.ia=0x10000;this.V=[0,48,64,96,128,192,0x100,384,512,768,1024];this.ja=3E4;this.ha=80};
sjcl.prng.prototype={randomWords:function(a,b){var c=[],d;d=this.isReady(b);var e;d===this.B&&p(new sjcl.exception.notReady("generator isn't seeded"));if(d&this.M){d=!(d&this.L);e=[];var f=0,g;this.da=e[0]=171503+this.ja;for(g=0;g<this.i.length&&!(e=e.concat(this.i[g].finalize()),f+=this.u[g],this.u[g]=0,!d&&this.S&1<<g);g++);this.S>=1<<this.i.length&&(this.i.push(new sjcl.hash.sha256),this.u.push(0));this.m-=f;f>this.w&&(this.w=f);this.S++;this.d=sjcl.hash.sha256.hash(this.d.concat(e));this.P=new sjcl.cipher.aes(this.d);
for(d=0;4>d&&!(this.p[d]=this.p[d]+1|0,this.p[d]);d++);}for(d=0;d<a;d+=4)0===(d+1)%this.ia&&ea(this),e=U(this),c.push(e[0],e[1],e[2],e[3]);ea(this);return c.slice(0,a)},setDefaultParanoia:function(a,b){0===a&&"Setting paranoia=0 will ruin your security; use it only for testing"!==b&&p("Setting paranoia=0 will ruin your security; use it only for testing");this.Q=a},addEntropy:function(a,b,c){c=c||"user";var d,e,f=this.K[c],g=this.isReady(),h=0;d=this.X[c];d===r&&(d=this.X[c]=this.la++);f===r&&(f=this.K[c]=
0);this.K[c]=(this.K[c]+1)%this.i.length;switch(typeof a){case "number":b===r&&(b=1);this.i[f].update([d,this.R++,1,b,71503,1,a|0]);break;case "object":c=Object.prototype.toString.call(a);if("[object Uint32Array]"===c){e=[];for(c=0;c<a.length;c++)e.push(a[c]);a=e}else{"[object Array]"!==c&&(h=1);for(c=0;c<a.length&&!h;c++)"number"!==typeof a[c]&&(h=1)}if(!h){if(b===r)for(c=b=0;c<a.length;c++)for(e=a[c];0<e;)b++,e>>>=1;this.i[f].update([d,this.R++,2,b,71503,a.length].concat(a))}break;case "string":b===
r&&(b=a.length);this.i[f].update([d,this.R++,3,b,71503,a.length]);this.i[f].update(a);break;default:h=1}h&&p(new sjcl.exception.bug("random: addEntropy only supports number, array of numbers or string"));this.u[f]+=b;this.m+=b;g===this.B&&(this.isReady()!==this.B&&fa("seeded",Math.max(this.w,this.m)),fa("progress",this.getProgress()))},isReady:function(a){a=this.V[a!==r?a:this.Q];return this.w&&this.w>=a?this.u[0]>this.ha&&0>this.da?this.M|this.L:this.L:this.m>=a?this.M|this.B:this.B},getProgress:function(a){a=
this.V[a?a:this.Q];return this.w>=a?1:this.m>a?1:this.m/a},startCollectors:function(){this.H||(this.H=x)},stopCollectors:function(){this.H&&(window.removeEventListener?(window.removeEventListener("load",this.s.loadTimeCollector,C),window.removeEventListener("mousemove",this.s.mouseCollector,C),window.removeEventListener("keypress",this.s.keyboardCollector,C),window.removeEventListener("devicemotion",this.s.accelerometerCollector,C)):document.detachEvent&&(document.detachEvent("onload",this.s.loadTimeCollector),
document.detachEvent("onmousemove",this.s.mouseCollector),document.detachEvent("keypress",this.s.keyboardCollector)),this.H=C)},addEventListener:function(a,b){this.O[a][this.ka++]=b},removeEventListener:function(a,b){var c,d,e=this.O[a],f=[];for(d in e)e.hasOwnProperty(d)&&e[d]===b&&f.push(d);for(c=0;c<f.length;c++)d=f[c],delete e[d]},ua:function(a){var b=this;return function(){a.apply(b,arguments)}},wa:function(){Z(1)},ya:function(a){sjcl.random.addEntropy([a.x||a.clientX||a.offsetX||0,a.y||a.clientY||
a.offsetY||0],2,"mouse");Z(0)},xa:function(){Z(2)},ta:function(a){a=a.accelerationIncludingGravity.x||a.accelerationIncludingGravity.y||a.accelerationIncludingGravity.z;if(window.orientation){var b=window.orientation;"number"===typeof b&&sjcl.random.addEntropy(b,1,"accelerometer")}a&&sjcl.random.addEntropy(a,2,"accelerometer");Z(0)}};function fa(a,b){var c,d=sjcl.random.O[a],e=[];for(c in d)d.hasOwnProperty(c)&&e.push(d[c]);for(c=0;c<e.length;c++)e[c](b)}
function Z(a){window&&window.performance&&"function"===typeof window.performance.now?sjcl.random.addEntropy(window.performance.now(),a,"loadtime"):sjcl.random.addEntropy(7117,a,"loadtime")}function ea(a){a.d=U(a).concat(U(a));a.P=new sjcl.cipher.aes(a.d)}function U(a){for(var b=0;4>b&&!(a.p[b]=a.p[b]+1|0,a.p[b]);b++);return a.P.encrypt(a.p)}sjcl.random=new sjcl.prng(0);
sjcl.json={defaults:{v:1,iter:1E3,ks:128,ts:64,mode:"ccm",adata:"",cipher:"aes"},na:function(a,b,c,d){c=c||{};d=d||{};var e=sjcl.json,f=e.o({iv:sjcl.random.randomWords(4,0)},e.defaults),g;e.o(f,c);c=f.adata;"string"===typeof f.salt&&(f.salt=sjcl.codec.base64.toBits(f.salt));"string"===typeof f.iv&&(f.iv=sjcl.codec.base64.toBits(f.iv));(!sjcl.mode[f.mode]||!sjcl.cipher[f.cipher]||"string"===typeof a&&100>=f.iter||64!==f.ts&&96!==f.ts&&128!==f.ts||128!==f.ks&&192!==f.ks&&0x100!==f.ks||2>f.iv.length||
4<f.iv.length)&&p(new sjcl.exception.invalid("json encrypt: invalid parameters"));"string"===typeof a?(g=sjcl.misc.cachedPbkdf2(a,f),a=g.key.slice(0,f.ks/32),f.salt=g.salt):sjcl.ecc&&a instanceof sjcl.ecc.elGamal.publicKey&&(g=a.kem(),f.kemtag=g.tag,a=g.key.slice(0,f.ks/32));"string"===typeof b&&(b=sjcl.codec.utf8String.toBits(b));"string"===typeof c&&(c=sjcl.codec.utf8String.toBits(c));g=new sjcl.cipher[f.cipher](a);e.o(d,f);d.key=a;f.ct=sjcl.mode[f.mode].encrypt(g,b,f.iv,c,f.ts);return f},encrypt:function(a,
b,c,d){var e=sjcl.json,f=e.na.apply(e,arguments);return e.encode(f)},ma:function(a,b,c,d){c=c||{};d=d||{};var e=sjcl.json;b=e.o(e.o(e.o({},e.defaults),b),c,x);var f;c=b.adata;"string"===typeof b.salt&&(b.salt=sjcl.codec.base64.toBits(b.salt));"string"===typeof b.iv&&(b.iv=sjcl.codec.base64.toBits(b.iv));(!sjcl.mode[b.mode]||!sjcl.cipher[b.cipher]||"string"===typeof a&&100>=b.iter||64!==b.ts&&96!==b.ts&&128!==b.ts||128!==b.ks&&192!==b.ks&&0x100!==b.ks||!b.iv||2>b.iv.length||4<b.iv.length)&&p(new sjcl.exception.invalid("json decrypt: invalid parameters"));
"string"===typeof a?(f=sjcl.misc.cachedPbkdf2(a,b),a=f.key.slice(0,b.ks/32),b.salt=f.salt):sjcl.ecc&&a instanceof sjcl.ecc.elGamal.secretKey&&(a=a.unkem(sjcl.codec.base64.toBits(b.kemtag)).slice(0,b.ks/32));"string"===typeof c&&(c=sjcl.codec.utf8String.toBits(c));f=new sjcl.cipher[b.cipher](a);c=sjcl.mode[b.mode].decrypt(f,b.ct,b.iv,c,b.ts);e.o(d,b);d.key=a;return sjcl.codec.utf8String.fromBits(c)},decrypt:function(a,b,c,d){var e=sjcl.json;return e.ma(a,e.decode(b),c,d)},encode:function(a){var b,
...
a=a.replace(/^\{|\}$/g,"").split(/,/);var b={},c,d;for(c=0;c<a.length;c++)(d=a[c].match(/^(?:(["']?)([a-z][a-z0-9]*)\1):(?:(\d+)|"([a-z0-9+\/%*_.@=\-]*)")$/i))||p(new sjcl.exception.invalid("json decode: this isn't json!")),b[d[2]]=d[3]?parseInt(d[3],10):d[2].match(/^(ct|salt|iv)$/)?sjcl.codec.base64.toBits(d[4]):unescape(d[4]);return b},o:function(a,b,c){a===r&&(a={});if(b===r)return a;for(var d in b)b.hasOwnProperty(d)&&(c&&(a[d]!==r&&a[d]!==b[d])&&p(new sjcl.exception.invalid("required parameter overridden")),
a[d]=b[d]);return a},za:function(a,b){var c={},d;for(d in a)a.hasOwnProperty(d)&&a[d]!==b[d]&&(c[d]=a[d]);return c},va:function(a,b){var c={},d;for(d=0;d<b.length;d++)a[b[d]]!==r&&(c[b[d]]=a[b[d]]);return c}};sjcl.encrypt=sjcl.json.encrypt;sjcl.decrypt=sjcl.json.decrypt;sjcl.misc.sa={};
sjcl.misc.cachedPbkdf2=function(a,b){var c=sjcl.misc.sa,d;b=b||{};d=b.iter||1E3;c=c[a]=c[a]||{};d=c[d]=c[d]||{firstSalt:b.salt&&b.salt.length?b.salt.slice(0):sjcl.random.randomWords(2,0)};c=b.salt===r?d.firstSalt:b.salt;d[c]=d[c]||sjcl.misc.pbkdf2(a,c,b.iter);return{key:d[c].slice(0),salt:c.slice(0)}};sjcl.bn=function(a){this.initWith(a)};
sjcl.bn.prototype={radix:24,maxMul:8,h:sjcl.bn,copy:function(){return new this.h(this)},initWith:function(a){var b=0,c;switch(typeof a){case "object":this.limbs=a.limbs.slice(0);break;case "number":this.limbs=[a];this.normalize();break;case "string":a=a.replace(/^0x/,"");this.limbs=[];c=this.radix/4;for(b=0;b<a.length;b+=c)this.limbs.push(parseInt(a.substring(Math.max(a.length-b-c,0),a.length-b),16));break;default:this.limbs=[0]}return this},equals:function(a){"number"===typeof a&&(a=new this.h(a));
...
toBits:function(){return sjcl.bitArray.concat(this.x.toBits(),this.y.toBits())}};sjcl.ecc.pointJac=function(a,b,c,d){b===r?this.isIdentity=x:(this.x=b,this.y=c,this.z=d,this.isIdentity=C);this.curve=a};
...
sjcl.ecc.elGamal={generateKeys:sjcl.ecc.basicKey.generateKeys("elGamal"),publicKey:function(a,b){sjcl.ecc.basicKey.publicKey.apply(this,arguments)},secretKey:function(a,b){sjcl.ecc.basicKey.secretKey.apply(this,arguments)}};sjcl.ecc.elGamal.publicKey.prototype={kem:function(a){a=sjcl.bn.random(this.k.r,a);var b=this.k.G.mult(a).toBits();return{key:sjcl.hash.sha256.hash(this.J.mult(a).toBits()),tag:b}}};
sjcl.ecc.elGamal.secretKey.prototype={unkem:function(a){return sjcl.hash.sha256.hash(this.k.fromBits(a).mult(this.I).toBits())},dh:function(a){return sjcl.hash.sha256.hash(a.J.mult(this.I).toBits())}};sjcl.ecc.ecdsa={generateKeys:sjcl.ecc.basicKey.generateKeys("ecdsa")};sjcl.ecc.ecdsa.publicKey=function(a,b){sjcl.ecc.basicKey.publicKey.apply(this,arguments)};
sjcl.ecc.ecdsa.publicKey.prototype={verify:function(a,b,c){sjcl.bitArray.bitLength(a)>this.q&&(a=sjcl.bitArray.clamp(a,this.q));var d=sjcl.bitArray,e=this.k.r,f=this.q,g=sjcl.bn.fromBits(d.bitSlice(b,0,f)),d=sjcl.bn.fromBits(d.bitSlice(b,f,2*f)),h=c?d:d.inverseMod(e),f=sjcl.bn.fromBits(a).mul(h).mod(e),h=g.mul(h).mod(e),f=this.k.G.mult2(f,h,this.J).x;if(g.equals(0)||d.equals(0)||g.greaterEquals(e)||d.greaterEquals(e)||!f.equals(g)){if(c===r)return this.verify(a,b,x);p(new sjcl.exception.corrupt("signature didn't check out"))}return x}};
sjcl.ecc.ecdsa.secretKey=function(a,b){sjcl.ecc.basicKey.secretKey.apply(this,arguments)};sjcl.ecc.ecdsa.secretKey.prototype={sign:function(a,b,c,d){sjcl.bitArray.bitLength(a)>this.q&&(a=sjcl.bitArray.clamp(a,this.q));var e=this.k.r,f=e.bitLength();d=d||sjcl.bn.random(e.sub(1),b).add(1);b=this.k.G.mult(d).x.mod(e);a=sjcl.bn.fromBits(a).add(b.mul(this.I));c=c?a.inverseMod(e).mul(d).mod(e):a.mul(d.inverseMod(e)).mod(e);return sjcl.bitArray.concat(b.toBits(f),c.toBits(f))}};
sjcl.keyexchange.srp={makeVerifier:function(a,b,c,d){a=sjcl.keyexchange.srp.makeX(a,b,c);a=sjcl.bn.fromBits(a);return d.g.powermod(a,d.N)},makeX:function(a,b,c){a=sjcl.hash.sha1.hash(a+":"+b);return sjcl.hash.sha1.hash(sjcl.bitArray.concat(c,a))},knownGroup:function(a){"string"!==typeof a&&(a=a.toString());sjcl.keyexchange.srp.Z||sjcl.keyexchange.srp.pa();return sjcl.keyexchange.srp.ba[a]},Z:C,pa:function(){var a,b;for(a=0;a<sjcl.keyexchange.srp.aa.length;a++)b=sjcl.keyexchange.srp.aa[a].toString(),
b=sjcl.keyexchange.srp.ba[b],b.N=new sjcl.bn(b.N),b.g=new sjcl.bn(b.g);sjcl.keyexchange.srp.Z=x},aa:[1024,1536,2048],ba:{1024:{N:"",g:2},1536:{N:"",
...
g:2}}};
"sjcl-unsafenonrandom-1.0.0.min.js";
