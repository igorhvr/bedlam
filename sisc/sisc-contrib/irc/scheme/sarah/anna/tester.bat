...
if exist .\logs\chat\Anna\chat.xml del .\logs\chat\Anna\chat.xml
if exist .\ffm\Anna\*.predicates del .\ffm\Anna\*.predicates
rem server < testcase.txt

:warn
echo ----
echo This is the Program D testing utility.
echo It will erase your current chat.xml log!
echo It will also erase all client-specific predicates
echo 
