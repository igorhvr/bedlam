...
; $Id: sxpath-ext.scm,v 1.2 2007/04/12 03:51:18 acolomba Exp $:
;
...
; Added by lee@lshift.net: Moved (define) to top of file to satisfy SISC
(define sxml:equality-cmp)
...
;
; Added by lee@lshift.net: Moved (define) to top of document to satisfy SISC
(set! sxml:equality-cmp (lambda (bool-op number-op string-op)
  (lambda (obj1 obj2)
    (cond
