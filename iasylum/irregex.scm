...
;; irregex
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.9.0/irregex.scc"))
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.9.0/irregex-utils.scc"))
