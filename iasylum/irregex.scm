...
;; irregex
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.8.3/irregex.scm"))
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.8.3/irregex-utils.scm"))
