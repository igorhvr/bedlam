...
;; irregex
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.8.3/irregex.scc"))
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.8.3/irregex-utils.scc"))
