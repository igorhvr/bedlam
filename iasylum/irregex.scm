...
;; irregex
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.8.1/irregex.scm"))
(load (string-append (iasylum-bedlam-location) "iasylum/irregex/irregex-0.8.1/irregex-utils.scm"))
